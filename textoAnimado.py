...
#crearAnimacion(10,50, 'Z')
    ...
    p_1 = multiprocessing.Process( name='proceso 1',target=crearAnimacion)
    p_2 = multiprocessing.Process( name='proceso 2',target=crearAnimacion)
    p_3 = multiprocessing.Process( name='proceso 3',target=crearAnimacion)
